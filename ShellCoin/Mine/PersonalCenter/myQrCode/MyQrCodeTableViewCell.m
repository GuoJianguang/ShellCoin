...
@implementation MyQrCodeTableViewCell
...
- (void)runShareWithType:(UMSocialPlatformType)type withTitle:(NSString *)title withUrl:(NSString *)url
{
    ...
    UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:title descr:@"欢迎关注" thumImage:[UIImage imageNamed:@"shareicon"]];
    //设置网页地址
